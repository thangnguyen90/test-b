    ...
    if settings.mysql_enabled:
        try:
            ...
            paper_trade_engine = PaperTradingEngine(
                ...
                candles_bg_surge_discord_webhook_enabled=settings.paper_trade_ml_candles_bg_surge_discord_webhook_enabled,
                candles_bg_surge_discord_webhook_url=settings.paper_trade_ml_candles_bg_surge_discord_webhook_url,
                candles_bg_surge_discord_webhook_username=settings.paper_trade_ml_candles_bg_surge_discord_webhook_username,
                candles_bg_surge_min_long_probability=settings.paper_trade_ml_candles_bg_surge_min_long_probability,
                candles_bg_surge_discord_cooldown_minutes=settings.paper_trade_ml_candles_bg_surge_discord_cooldown_minutes,
                candles_bg_vol_guard_enabled=settings.paper_trade_ml_candles_bg_vol_guard_enabled,
                candles_bg_vol_guard_block_level=settings.paper_trade_ml_candles_bg_vol_guard_block_level,
                candles_bg_vol_guard_atr_threshold_pct=settings.paper_trade_ml_candles_bg_vol_guard_atr_threshold_pct,
                candles_bg_vol_guard_pump_threshold_x=settings.paper_trade_ml_candles_bg_vol_guard_pump_threshold_x,
                candles_bg_vol_guard_short_block_on_vol_up=settings.paper_trade_ml_candles_bg_vol_guard_short_block_on_vol_up,
                candles_bg_vol_guard_volume_trend_ratio=settings.paper_trade_ml_candles_bg_vol_guard_volume_trend_ratio,
                candles_bg_vol_guard_volume_accel_ratio=settings.paper_trade_ml_candles_bg_vol_guard_volume_accel_ratio,
                candles_bg_vol_guard_cache_sec=settings.paper_trade_ml_candles_bg_vol_guard_cache_sec,
                candles_bg_vol_guard_discord_cooldown_minutes=settings.paper_trade_ml_candles_bg_vol_guard_discord_cooldown_minutes,
