    ...
    if settings.mysql_enabled:
        try:
            ...
            paper_trade_engine = PaperTradingEngine(
                ...
                test_ml_fixed_sl_pct=settings.paper_trade_test_ml_fixed_sl_pct,
                test_ml_tp_min_pct=settings.paper_trade_test_ml_tp_min_pct,
                test_ml_tp_max_pct=settings.paper_trade_test_ml_tp_max_pct,
                test_ml_max_hold_minutes=settings.paper_trade_test_ml_max_hold_minutes,
                test_ml_timeout_min_pnl_usdt=settings.paper_trade_test_ml_timeout_min_pnl_usdt,
                ...
                short_bad_hour_block_enabled=settings.paper_trade_short_bad_hour_block_enabled,
                short_bad_hour_block_hours_vn=settings.paper_trade_short_bad_hour_block_hours_vn,
                short_bad_hour_block_on_btc_bullish=settings.paper_trade_short_bad_hour_block_on_btc_bullish,
                short_bad_hour_block_min_btc_confidence=settings.paper_trade_short_bad_hour_block_min_btc_confidence,
                short_bad_hour_block_on_non_btc_follow=settings.paper_trade_short_bad_hour_block_on_non_btc_follow,
                btc_wave_bad_hour_block_enabled=settings.paper_trade_btc_wave_bad_hour_block_enabled,
                btc_wave_bad_hour_block_hours_vn=settings.paper_trade_btc_wave_bad_hour_block_hours_vn,
                btc_wave_bad_hour_block_min_confidence=settings.paper_trade_btc_wave_bad_hour_block_min_confidence,
                btc_wave_bad_hour_block_apply_non_btc_follow=settings.paper_trade_btc_wave_bad_hour_block_apply_non_btc_follow,
                high_prob_guard_enabled=settings.paper_trade_high_prob_guard_enabled,
                high_prob_guard_min_effective_win=settings.paper_trade_high_prob_guard_min_effective_win,
                high_prob_guard_min_samples=settings.paper_trade_high_prob_guard_min_samples,
                high_prob_guard_countertrend_btc_confidence=settings.paper_trade_high_prob_guard_countertrend_btc_confidence,
                high_prob_guard_block_non_btc_follow=settings.paper_trade_high_prob_guard_block_non_btc_follow,
                pre_entry_mae_guard_enabled=settings.paper_trade_pre_entry_mae_guard_enabled,
                pre_entry_mae_lookback_days=settings.paper_trade_pre_entry_mae_lookback_days,
                pre_entry_mae_min_samples=settings.paper_trade_pre_entry_mae_min_samples,
                pre_entry_mae_quantile=settings.paper_trade_pre_entry_mae_quantile,
                pre_entry_mae_max_abs_pct=settings.paper_trade_pre_entry_mae_max_abs_pct,
                pre_entry_mae_max_sl_ratio=settings.paper_trade_pre_entry_mae_max_sl_ratio,
                pre_entry_mae_cache_sec=settings.paper_trade_pre_entry_mae_cache_sec,
