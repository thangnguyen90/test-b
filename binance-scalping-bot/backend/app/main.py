...
async def on_startup() -> None:
    ...
    paper_trade_api.bind_major_symbols_snapshot_getter(None)
    if settings.mysql_enabled:
        try:
            ...
            paper_trade_engine = PaperTradingEngine(
                ...
                btc_overheat_long_block_enabled=settings.paper_trade_btc_overheat_long_block_enabled,
                btc_overheat_rsi_15m_max=settings.paper_trade_btc_overheat_rsi_15m_max,
                btc_overheat_rsi_1h_max=settings.paper_trade_btc_overheat_rsi_1h_max,
            ...
            paper_trade_api.bind_major_symbols_snapshot_getter(paper_trade_engine.get_major_symbols_snapshot)
