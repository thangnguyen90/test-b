    ...
    if settings.mysql_enabled:
        try:
            ...
            paper_trade_engine = PaperTradingEngine(
                ...
                day_start_hour=settings.paper_trade_day_start_hour,
                day_end_hour=settings.paper_trade_day_end_hour,
                day_tp_margin_min_pct=settings.paper_trade_day_tp_margin_min_pct,
                day_tp_margin_max_pct=settings.paper_trade_day_tp_margin_max_pct,
                day_sl_margin_pct=settings.paper_trade_day_sl_margin_pct,
                night_tp_margin_min_pct=settings.paper_trade_night_tp_margin_min_pct,
                night_tp_margin_max_pct=settings.paper_trade_night_tp_margin_max_pct,
                night_sl_margin_pct=settings.paper_trade_night_sl_margin_pct,
