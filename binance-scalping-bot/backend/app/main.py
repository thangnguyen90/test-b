    ...
    if settings.mysql_enabled:
        try:
            ...
            paper_trade_engine = PaperTradingEngine(
                ...
                dynamic_major_leverage_cap=settings.paper_trade_dynamic_major_leverage_cap,
                dynamic_major_min_turnover_usdt=settings.paper_trade_dynamic_major_min_turnover_usdt,
                poll_interval_sec=settings.paper_trade_poll_interval_sec,
                stream_max_stale_sec=settings.paper_trade_stream_max_stale_sec,
                entry_touch_buffer_pct=settings.paper_trade_entry_touch_buffer_pct,
                ...
                small_cap_oi_hard_floor=settings.paper_trade_small_cap_oi_hard_floor,
                small_cap_oi_soft_floor=settings.paper_trade_small_cap_oi_soft_floor,
                low_oi_entry_extra_pct=settings.paper_trade_low_oi_entry_extra_pct,
                small_cap_max_leverage=settings.paper_trade_small_cap_max_leverage,
                max_abs_funding_rate=settings.paper_trade_max_abs_funding_rate,
                min_long_short_ratio=settings.paper_trade_min_long_short_ratio,
                max_long_short_ratio=settings.paper_trade_max_long_short_ratio,
