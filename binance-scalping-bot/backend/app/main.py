    ...
    if settings.mysql_enabled:
        try:
            ...
            paper_trade_engine = PaperTradingEngine(
                ...
                volatility_guard_enabled=settings.paper_trade_volatility_guard_enabled,
                volatility_guard_timeframe=settings.paper_trade_volatility_guard_timeframe,
                volatility_guard_limit=settings.paper_trade_volatility_guard_limit,
                volatility_guard_cache_sec=settings.paper_trade_volatility_guard_cache_sec,
                volatility_guard_max_atr_pct=settings.paper_trade_volatility_guard_max_atr_pct,
                volatility_guard_max_range_pct=settings.paper_trade_volatility_guard_max_range_pct,
                volatility_guard_max_body_pct=settings.paper_trade_volatility_guard_max_body_pct,
                volatility_guard_max_range_atr_ratio=settings.paper_trade_volatility_guard_max_range_atr_ratio,
