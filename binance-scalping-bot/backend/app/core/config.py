...
class Settings(BaseModel):
    ...
    paper_trade_day_start_hour: int = int(os.getenv("PAPER_TRADE_DAY_START_HOUR", "10"))
    paper_trade_day_end_hour: int = int(os.getenv("PAPER_TRADE_DAY_END_HOUR", "18"))
    paper_trade_day_tp_margin_min_pct: float = float(os.getenv("PAPER_TRADE_DAY_TP_MARGIN_MIN_PCT", "2.0"))
    paper_trade_day_tp_margin_max_pct: float = float(os.getenv("PAPER_TRADE_DAY_TP_MARGIN_MAX_PCT", "2.5"))
    paper_trade_day_sl_margin_pct: float = float(os.getenv("PAPER_TRADE_DAY_SL_MARGIN_PCT", "7.0"))
    paper_trade_night_tp_margin_min_pct: float = float(os.getenv("PAPER_TRADE_NIGHT_TP_MARGIN_MIN_PCT", "3.0"))
    paper_trade_night_tp_margin_max_pct: float = float(os.getenv("PAPER_TRADE_NIGHT_TP_MARGIN_MAX_PCT", "3.0"))
    paper_trade_night_sl_margin_pct: float = float(os.getenv("PAPER_TRADE_NIGHT_SL_MARGIN_PCT", "10.0"))
