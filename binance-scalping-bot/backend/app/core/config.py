...
class Settings(BaseModel):
    ...
    ema99_bounce_paper_trade_enabled: bool = os.getenv("EMA99_BOUNCE_PAPER_TRADE_ENABLED", "true").lower() == "true"
    ema99_bounce_paper_min_score: float = float(os.getenv("EMA99_BOUNCE_PAPER_MIN_SCORE", "4"))
    ema99_bounce_paper_signal_cooldown_sec: int = int(os.getenv("EMA99_BOUNCE_PAPER_SIGNAL_COOLDOWN_SEC", "21600"))
    ema99_bounce_paper_order_usdt: float = float(os.getenv("EMA99_BOUNCE_PAPER_ORDER_USDT", "100"))
    ema99_bounce_paper_margin_usdt: float = float(os.getenv("EMA99_BOUNCE_PAPER_MARGIN_USDT", "20"))
    ema99_bounce_paper_leverage: int = int(os.getenv("EMA99_BOUNCE_PAPER_LEVERAGE", "5"))
    ema99_bounce_paper_strong_min_score: float = float(os.getenv("EMA99_BOUNCE_PAPER_STRONG_MIN_SCORE", "5"))
    ema99_bounce_paper_strong_leverage: int = int(os.getenv("EMA99_BOUNCE_PAPER_STRONG_LEVERAGE", "10"))
    ...
    pump_hunter_bg_max_symbols: int = int(os.getenv("PUMP_HUNTER_BG_MAX_SYMBOLS", "250"))
