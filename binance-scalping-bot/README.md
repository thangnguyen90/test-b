...
PAPER_TRADE_DAY_START_HOUR=10
PAPER_TRADE_DAY_END_HOUR=18
PAPER_TRADE_DAY_TP_MARGIN_MIN_PCT=2.0
PAPER_TRADE_DAY_TP_MARGIN_MAX_PCT=2.5
PAPER_TRADE_DAY_SL_MARGIN_PCT=7.0
PAPER_TRADE_NIGHT_TP_MARGIN_MIN_PCT=3.0
PAPER_TRADE_NIGHT_TP_MARGIN_MAX_PCT=3.0
PAPER_TRADE_NIGHT_SL_MARGIN_PCT=10.0
...
- `PAPER_TRADE_DAY_START_HOUR`/`PAPER_TRADE_DAY_END_HOUR` định nghĩa khung giờ ban ngày (theo giờ VN, gồm cả giờ kết thúc).
- `PAPER_TRADE_DAY_TP_MARGIN_MIN_PCT`/`PAPER_TRADE_DAY_TP_MARGIN_MAX_PCT` và `PAPER_TRADE_DAY_SL_MARGIN_PCT` là TP/SL theo `% margin` cho khung ban ngày.
- `PAPER_TRADE_NIGHT_TP_MARGIN_MIN_PCT`/`PAPER_TRADE_NIGHT_TP_MARGIN_MAX_PCT` và `PAPER_TRADE_NIGHT_SL_MARGIN_PCT` là TP/SL theo `% margin` cho khung ngoài giờ ban ngày.
