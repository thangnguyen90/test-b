...
PAPER_TRADE_DYNAMIC_MAJOR_LEVERAGE_CAP=5
PAPER_TRADE_DYNAMIC_MAJOR_MIN_TURNOVER_USDT=5000000
PAPER_TRADE_POLL_INTERVAL_SEC=6
PAPER_TRADE_ENTRY_TOUCH_BUFFER_PCT=0.0008
...
PAPER_TRADE_SMALL_CAP_OI_HARD_FLOOR=8000000
PAPER_TRADE_SMALL_CAP_OI_SOFT_FLOOR=25000000
PAPER_TRADE_LOW_OI_ENTRY_EXTRA_PCT=0.01
PAPER_TRADE_SMALL_CAP_MAX_LEVERAGE=3
PAPER_TRADE_MAX_ABS_FUNDING_RATE=0.0012
PAPER_TRADE_MIN_LONG_SHORT_RATIO=0.65
PAPER_TRADE_MAX_LONG_SHORT_RATIO=1.85
...
- `PAPER_TRADE_ENTRY_TOUCH_BUFFER_PCT` siết điều kiện chạm điểm vào (buffer nhỏ hơn -> vào lệnh kỹ hơn).
- `PAPER_TRADE_SL_ATR_MULTIPLIER` dùng ATR để đặt ngưỡng SL tối thiểu theo biến động (0 = tắt ATR).
- Bộ `PAPER_TRADE_SMALL_CAP_*`, `PAPER_TRADE_MAX_ABS_FUNDING_RATE`, `PAPER_TRADE_*LONG_SHORT_RATIO*` dùng để chặn/giảm leverage ở coin dễ bị bơm thổi.
- `PAPER_TRADE_LOW_OI_ENTRY_EXTRA_PCT` dời entry xa hơn khi OI quá thấp để tránh đuổi theo nến bơm/xả.
